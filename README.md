...
| 检测层级 | 模式定位 | 核心目标 | 耗时与 Token 消耗 | 开放形态 |
| :--- | :--- | :--- | :--- | :--- |
| **L1 极速黑盒体检** | **功能与协议排障** | 协议规范、SSE 流式、Tools、视觉多模态、Prompt Caching、参数容差矩阵 | **15~30 秒**<br>约 3K~5K Tokens | **开源开放（本项目）**<br>CLI / 本地 / CI 均可跑 |
| **L2 行为指纹比对** | **模型防伪鉴真** | 8组判别知识盲区、指令遵从边界、对齐风格，提取特征向量比对 | **1~2 分钟**<br>约 2.5 万 Tokens | **云端金标库**<br>需对比官方基准指纹 |
| **L3 深度能力曲线** | **性能与降智筛查** | 参数化数理、代码逻辑、长文本对抗评测，识别量化缩水与模型降智 | **3~5 分钟**<br>约 10 万 Tokens | **在线深度评测站**<br>防刷题动态题库 |
